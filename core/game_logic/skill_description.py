...
from .enums import StatNature, StatType
...
from .skill_builder import get_skill_damage_count
...
def format_skill_description_args(
	...
	*,
	...
	SkillVisualDetails include-duration flag is not ported; callers pass include_duration
	until VisualConfig IL is available.
	"""
