...
# from core.game_logic.player_model import ItemModel, PlayerModel, StatModel
#
#
# _STAT_POOL: list[str] = StatHelper.stat_pool()
#
#
...
# 	return [t for t in ItemType if age in _CATALOG[t]]
#
#
...
# 			label = StatHelper.display_name(s.stat_type.name)
