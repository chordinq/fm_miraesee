...
IN_APP_PRODUCTS = load_json(CONFIG_DIR / "InAppProducts.json")
BASE_CONFIG = load_json(CONFIG_DIR / "BaseConfig.json")
...
HAMMER_THEIF_DUNGEON_BATTLE_LIBRARY = load_json(GAME_CONFIGS_DIR / "HammerTheifDungeonBattleLibrary.json")
...
SKIN_LIBRARY = load_json(GAME_CONFIGS_DIR / "SkinLibrary.json")
SKINS_UPGRADE_LIBRARY = load_json(GAME_CONFIGS_DIR / "SkinsUpgradeLibrary.json")
SET_LIBRARY = load_json(GAME_CONFIGS_DIR / "SetLibrary.json")
